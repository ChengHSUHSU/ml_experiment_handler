...
from model_handler.utils.inputs import build_input_features, SparseFeat, DenseFeat, VarLenSparseFeat, get_varlen_pooling_list, \
    create_embedding_matrix
from model_handler.model.layers.core import PredictionLayer
from model_handler.model.layers.utils import slice_arrays
from model_handler.utils.callbacks import History
...
class BaseModel(nn.Module):
    ...
    def fit(self, x=None, y=None, batch_size=None, epochs=1, verbose=1, initial_epoch=0, validation_split=0.,
            validation_data=None, shuffle=True, callbacks=None, **kwargs):
        """
